...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		String attack = JOptionPane.showInputDialog("attack the dragon with the move yell or kick.");
		...
		{
			JOptionPane.showMessageDialog(null, "You defeated the dragon and earned tons of gold!");
		}
	   ...
	   //  15.  Else
		else
		{
			...
			+ dragonHealth + "\n" + "player health lost: " + playerDamage + "\n" + "dragon health lost: " 
			+ dragonDamage);
		}
